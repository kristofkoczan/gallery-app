                            ...
                            <tbody>
                                <tr>
                                    {comment.author === store.getState()[0].username ? 
                                        <th style={{width: '30px', border: '1px solid white', backgroundColor: '#638396', borderRadius: '10px', padding: '4px 0px 0px 0px'}}><FaTimes id={'commentDelete'} onClick={() => deleteComment(comment.comment, picture.id, comment.commentID)}/></th> 
